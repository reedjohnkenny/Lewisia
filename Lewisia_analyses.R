...
autoplot(pcr_morpho_dat, data = Lewisia_morpho, colour = 'Taxon', loadings = TRUE, frame = TRUE, frame.type = 'norm', loadings.label = TRUE, loadings.colour = "black", loadings.label.size = 4, loadings.label.colour = "black") +
  geom_point(aes(fill = Taxon, shape = Taxon), colour = "black", size = 2) +
